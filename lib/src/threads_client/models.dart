...
import '../generated/threads.pb.dart';
import '../generated/threads.pbgrpc.dart';
...
class Collection {
  ...
  Map<String, dynamic> toJson() => Map<String, dynamic>.from({'name': name, 'schema': schema});
  // Internal method
...
class Info {
  ...
  Map<String, dynamic> toJson() => Map<String, dynamic>.from({'addresses': addresses, 'key': key});
...
class ListenResult {
  ...
  Map<String, dynamic> toJson() => Map<String, dynamic>.from({'collectionName': collectionName, 'instanceID': instanceID, 'action': action, 'instance': instance});
}
...
class _QuerySort {
  ...
  Map<String, dynamic> toJson() => Map<String, dynamic>.from({'fieldPath': fieldPath, 'desc': desc});
}
...
class _QueryCriterion {
  ...
  Map<String, dynamic> toJson() {
    final result = {'fieldPath': fieldPath, 'operation': operation};
    if (value != null) {
...
List<_QueryCriterion> _createJSONCriterionList(List<dynamic> input) {
  ...
  for (var i = 0; i < input.length; i++) {
    results.add(_QueryCriterion.fromJson(Map<String, dynamic>.from(input[i])));
  }
...
List<Query> _createJSONQueryList(List<dynamic> input) {
  final results = [];
  for (var i = 0; i < input.length; i++) {
    results.add(Query.fromJson(Map<String, dynamic>.from(input[i])));
  }
